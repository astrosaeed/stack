...
class Robot(object):
    def __init__(self, is_sim, workspace_limits):
        ...
        if self.is_sim:
            ...
            #self.add_objects()
            #print ('hi')
            #vrep.simxLoadScene(self.sim_client,'/home/saeid/Dropbox/stack/stack.ttt',0x00,vrep.simx_opmode_blocking)
            #p = '/home/saeid/Downloads/pers/CoppeliaSim_Edu_V4_1_0_Ubuntu18_04/scenes/octreeGenerationDemo.ttt'
            #vrep.simxLoadScene(self.sim_client,p,0x00,vrep.simx_opmode_blocking)
    ...
    def setup_sim_camera(self):
        ...
        sim_ret, self.cam_handle = vrep.simxGetObjectHandle(self.sim_client, 'DefaultCamera', vrep.simx_opmode_blocking)
