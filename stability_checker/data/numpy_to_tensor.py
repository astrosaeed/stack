...
for i in range(num_classes): ###fix here
	data_dictionary[folders[i]] = sorted(glob.glob('/home/saeid/data/'+folders[i]+'/*.jpg')) 
...
all_data = np.zeros((len(data_dictionary['stable'])+len(data_dictionary['unstable']),25,25))
