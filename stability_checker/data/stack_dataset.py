...
class STACK_dataset(VisionDataset):
    ...
    def __init__(
        ...
        super(STACK_dataset, self).__init__(root, transform=transform,
    ...
    def download(self) -> None:
        ...
        training_set = (
            torch.load('/home/saeid/data/X_train.pt'),
            torch.load('/home/saeid/data/y_train.pt')
        )
        test_set = (
            torch.load('/home/saeid/data/X_test.pt'),
